...
- Action: Run a bounded, self-cleaning differential probe and open an issue with the diff; never mutate pre-existing records. Do not infer ordinary quota behavior from the privileged account.
