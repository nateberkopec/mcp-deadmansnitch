...
| INV-053 | Passing CI and a reviewer with no further feedback permits merge; factory changes also need a trusted review or owner-signed current head. | workflow, Factory Approval check | Partial |
